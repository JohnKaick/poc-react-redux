...
export default (props) => {
    ...
    const {
        participantes, participante, projetoId, nome, sobrenome, email, cliente, area, cargo, responsavel,
        open, close, onVincular, onChange, onParticipanteChange
    } = props
    ...
    return (
        <Modal
            ...
            <Modal.Content>
                ...
                <Message info content="Se o participante for responsável aparecerá na lista com a cor azul." />
            ...
            <Modal.Actions>
                <Button.Group className="ui left floated">
                    <DialogColaborador projetoId={projetoId}>
                        <Button color="grey" icon="plus" content="Cadastrar novo participante" />
                    </DialogColaborador>
                    {(participante) ? (
                        <DialogColaborador id={participante}>
                            <Button icon="edit" content="Editar" />
                        </DialogColaborador>
                    ) : null}
                </Button.Group>
                <Button.Group>
                    ...
                    <Button secondary icon="cancel" content="Cancelar" onClick={close} />
                </Button.Group>
            </Modal.Actions>
